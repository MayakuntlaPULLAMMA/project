...
const GTCP_Guidelines=()=>{
    ...
    return(
        ...
        <div className="bulletpoints_content">
            <p><div className="bullets"><li>The goal is to extract <i>GTCPs</i> with maximum coverage, while minimizing the overlap to zero. Hence, as a heuristic, we could
start with the coverage support value equal to 1 and
then progressively keep decreasing the value of coverage support until a desired number of <i>GTCPs</i> is obtained</li></div></p>
...
of <i>maxOR<sub>g</sub></i> until a desired number of <i>GTCPs</i> can be ob-
tained.</li></div></p>
