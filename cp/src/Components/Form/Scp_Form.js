    ...
    const handlesubmit=()=>{
        ...
        if(formData.minrf=='' || formData.mincs=='' || formData.maxor==''){
            ...
            if(formData.analysistype=='0'){
                ...
                data.append("structure_of_interest",submitted_si);
            ...
            <div className="div_with_formand_filters">
                <div className="input_form">
                    ...
                    <div className="form_body_main_div">
                        <Container className="Container">
                            <div className="entries_description">
                                <h6 className="entries_name"> Minimum Relative Frequency <FaIcons.FaInfoCircle onClick={()=>{show_modal_with_def("minrf")}} className="infocircle"/></h6>
                    ...
                    <div className="form_body_main_div">
                        <Container className="Container">
                            <div className="entries_description">
                                <h6 className="entries_name"> Minimum Coverage Support <FaIcons.FaInfoCircle onClick={()=>{show_modal_with_def("mincs")}} className="infocircle"/></h6>
                    ...
                    <div className="form_body_main_div">
                        <Container className="Container">
                            <div className="entries_description">
                                <h6 className="entries_name"> Maximum Overlap Ratio <FaIcons.FaInfoCircle onClick={()=>{show_modal_with_def("maxor")}} className="infocircle"/></h6>
                    ...
                    <div className="form_body_main_div">
                        <Container className="Container">
                            <div className="entries_description">
                                <h6 className="entries_name">Upload Dataset <FaIcons.FaInfoCircle onClick={()=>{show_modal_with_def("dataset")}}className="infocircle"/></h6>
                    ...
                    <div className="form_body_main_div">
                        <Container className="Container">
                            <div className="entries_description">
                                <h6 className="entries_name">Upload Corresponding Mapping File <FaIcons.FaInfoCircle onClick={()=>{show_modal_with_def("dataset_mapping")}}className="infocircle"/></h6>
                    ...
                    <div>
                        <Container className="Container">
                            <div className="entries_description">
                            {/* <Link to="/structureofinterest" target="_blank">Structure</Link> */}
                                    ...
                                    if(selected_filters_coverage.coverage==0 && item.cs>=selected_filters_coverage.csfrom && item.cs<=selected_filters_coverage.csto && item.or>=selected_filters_coverage.orfrom && item.or<=selected_filters_coverage.orto){
                                            ...
                                            return(
                                                ...
                                                <div className="image_table_data_string">
                                                        ...
                                                        <img src={`data:image/png;base64,${item.smile_graph_image}`} className="image1"></img>
                                                        </div>
