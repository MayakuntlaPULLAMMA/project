                                        ...
                                        return(
                                            ...
                                            <div className='card'>
                                                {item.graphs.map((item1,index1)=>{
                                                            ...
                                                            return(
                                                                <div>
                                                            <Barchart2 id={item1.graph_id} graph={item1.graph} coverage={item.size} ind={index1}/>
                                                                </div>
                                                            )
                                            ...
                                            <td className="cp_data">
                                                ...
                                                <td className="cp_data">
                                                <div className="image_table_data_smile_graph_image">
                                                
                                                    
                                                    
                                                        <div className="smile_graph" onClick={()=>handle_click_show_modal(item.smile_graph_image,index)}>
