...
drawChart() {
  ...
  var simulation = d3
    ...
    .force('link', d3.forceLink().links(this.props.graph.links))
    .on("tick", ticked);
...
render(){
  return <div className="interact_graph" id={"graph_"+String(this.props.id)+"_"+String(this.props.coverage)+"_"+String(this.props.ind)}></div>
}
